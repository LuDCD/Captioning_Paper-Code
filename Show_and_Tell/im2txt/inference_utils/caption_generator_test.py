...
# ==============================================================================
"""Unit tests for Caption Generator.Caption Generator的单元测试"""
...
class FakeVocab(object):
    ...
    def __init__(self):
        self.start_id = 0  # Word id denoting sentence start.单词id表示句子开始
        self.end_id = 1  # Word id denoting sentence end.


class FakeModel(object):
    """Fake model for testing purposes.用于测试目的的假模型。"""

    def __init__(self):
        # Number of words in the vocab.
        self._vocab_size = 12

        # Dimensionality of the nominal model state.标称模型状态的维数
        self._state_size = 1
